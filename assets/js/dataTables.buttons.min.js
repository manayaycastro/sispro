...
!function (a) {
    ...
    var e = a.fn.dataTable, f = 0, g = 0, h = e.ext.buttons, i = function (b, c) {
        c === !0 && (c = {}), a.isArray(c) && (c = {buttons: c}), this.c = a.extend(!0, {}, i.defaults, c), c.buttons && (this.c.buttons = c.buttons), this.s = {dt: new e.Api(b), buttons: [], subButtons: [], listenKeys: "", namespace: "dtb" + f++}, this.dom = {container: a("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className)}, this._constructor()
    };
    a.extend(i.prototype, {action: function (a, b) {
            ...
            for (a = d.length - 1; a >= 0; a--)
                null === d[a] && (d.splice(a, 1), e.splice(a, 1), this.c.buttons.splice(a, 1));
            for (a = 0, b = e.length; b > a; a++)
                for (c = e[a].length - 1; c >= 0; c--)
                    null === e[a][c] && (e[a].splice(c, 1), this.c.buttons[a].buttons.splice(c, 1));
            return this
            ...
            var c = this._indexToButton(a), e = this.c.dom.collection.buttonLiner, f = "string" == typeof a && -1 !== a.indexOf("-") && e && e.tag ? e.tag : this.c.dom.buttonLiner.tag, g = this.s.dt, h = function (a) {
            ...
            e._buttons || (e._buttons = []), e._buttons.push({inst: this, name: this.c.name}), this._buildButtons(this.c.buttons), d.on("destroy", function () {
                b.destroy()
            ...
            var d = this.c.dom.button, e = this.c.dom.buttonLiner, f = this.c.dom.collection, h = this.s.dt, i = function (a) {
                return"function" == typeof a ? a(h, k, b) : a
            };
            if (c && f.button && (d = f.button), c && f.buttonLiner && (e = f.buttonLiner), b.available && !b.available(h, b))
                return!1;
            ...
            var d, e, f, g, h = this.s.buttons, i = this.s.subButtons, j = function (d, e) {
                if (d.key)
                    if (d.key === b)
                        ...
                        if (d.key.key !== b)
                            return;
                        if (d.key.shiftKey && !c.shiftKey)
                            return;
                        if (d.key.altKey && !c.altKey)
                            return;
                        if (d.key.ctrlKey && !c.ctrlKey)
                            return;
                        if (d.key.metaKey && !c.metaKey)
                            return;
                        e.click()
                    }
            };
            ...
            for (d = 0, e = i.length; e > d; d++)
                for (f = 0, g = i[d].length; g > f; f++)
                    j(i[d][f].conf, i[d][f].node)
        }, _removeKey: function (b) {
            if (b.key) {
                var c = a.isPlainObject(b.key) ? b.key.key : b.key, d = this.s.listenKeys.split(""), e = a.inArray(c, d);
        ...
        var d = [], e = a.map(c, function (a) {
            ...
            if (a.isArray(b))
                ...
                "number" == typeof b && d.push(c[b].inst)
        };
        return f(b), d
        ...
        for (var e = [], f = function (b, c) {
            ...
            if (a.isArray(b) || b instanceof a)
                ...
                if (-1 !== b.indexOf(",")) {
                    ...
                    for (g = 0, h = i.length; h > g; g++)
                        i[g].name === l && e.push({inst: c, idx: c.toIndex(i[g].node)})
                } else
                    a(j).filter(b).each(function () {
        ...
        return e
    }, i.defaults = {buttons: ["copy", "excel", "csv", "pdf", "print"], name: "main", tabIndex: 0, dom: {container: {tag: "div", className: "dt-buttons"}, collection: {tag: "div", className: "dt-button-collection"}, button: {tag: "a", className: "dt-button", active: "active", disabled: "disabled"}, buttonLiner: {tag: "span", className: ""}}}, i.version = "1.1.2", a.extend(h, {collection: {text: function (a, b, c) {
                return a.i18n("buttons.collection", "Collection")
            }, className: "buttons-collection", action: function (d, e, f, g) {
            ...
            var d = b.settings()[0].aLengthMenu, e = a.isArray(d[0]) ? d[0] : d, f = a.isArray(d[0]) ? d[1] : d, g = function (a) {
                return a.i18n("buttons.pageLength", {"-1": "Show all rows", _: "Show %d rows"}, a.page.len())
            };
            return{extend: "collection", text: g, className: "buttons-page-length", autoClose: !0, buttons: a.map(e, function (a, b) {
                    return{text: f[b], action: function (b, c, d, e) {
                            c.page.len(a).draw()
                        }, init: function (b, c, d) {
    ...
    var k = a("<textarea/>")[0], l = function (b, c) {
        for (var d = a.extend(!0, {}, {rows: null, columns: "", modifier: {search: "applied", order: "applied"}, orthogonal: "display", stripHtml: !0, stripNewlines: !0, decodeEntities: !0, trim: !0, format: {header: function (a) {
                    return e(a)
                }, footer: function (a) {
                    return e(a)
                }, body: function (a) {
    ...
    }), e.ext.feature.push({fnInit: function (a) {
