...
<?php endif; ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Clase A </label>
...
value=""  />
                            ...
                            <div class="hr hr32 hr-dotted" style="margin-top: 7px; margin-bottom: 15px;"></div>
                             ...
                             <div class="form-group">
                                 ...
                                 <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Clase B - Telares </label>
                                <div class="col-sm-9">
                                    <input type="text"  required="required" placeholder="Clase b - Telares." class="form-control" 
                                           name="telares" id="telares"
 value="" 
                            ...
                            <div class="form-group">
                                 ...
                                 <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Clase B - Laminado </label>
                                <div class="col-sm-9">
                                    <input type="text"  required="required" placeholder="Clase b - laminado." class="form-control" 
                                           name="laminado" id="laminado"
 value="" 
                            ...
                            <div class="form-group">
                                 ...
                                 <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Clase B - Impresión </label>
                                <div class="col-sm-9">
                                    <input type="text"  required="required" placeholder="Clase b - impresion." class="form-control" 
                                           name="impresion" id="impresion"
 value="" 
                            ...
                            <div class="form-group">
                                 ...
                                 <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Clase B - Conversión </label>
                                <div class="col-sm-9">
                                    <input type="text"  required="required" placeholder="Clase b - conversión." class="form-control" 
...
<button type="button" class="btn btn-success btn-next" <?php echo $acceso; ?> data-last="Finish" id="btnguardardatosProdSacosConvfin">
                                        Guardar
       ...
       <div class="modal-footer">
          ...
          <button type="button" class="btn btn-sm btn-primary" id="btnActualizarRegistrossacosConv2">
...
<script src="view/js/kanbanlistasacos2.js"></script>     
...
<script type="text/javascript">
                                jQuery(function ($) {
                                    ...
                                    $('#modal-asignaravancesacos input[type=file]').ace_file_input({
                                        style: 'well',
                                        btn_choose: 'Drop files here or click to choose',
                                        btn_change: null,
                                        no_icon: 'ace-icon fa fa-cloud-upload',
                                    ...
                                    $('#modal-asignaravancesacos').on('shown.bs.modal', function () {
                                        if (!ace.vars['touch']) {
