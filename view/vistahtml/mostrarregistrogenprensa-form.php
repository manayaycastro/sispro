    ...
    <div class="modal-body">
        <div class="widget-box">
            <div class="widget-header widget-header-small">
                <h5 class="widget-title lighter">Filas Generadas</h5>
            </div>
          ...
          <table class="table table-bordered table-striped table-condensed table-hover" style="border-collapse: collapse;">
                            ...
                            <tbody >
                                <?php if($lista_filas): ?>
                                 <?php foreach ($lista_filas as $lista):?>
                                <tr>
                                    <td>
                                         <?php echo $lista['proroll_id']; ?>
                                    </td>
                                    <td>
                                          <?php echo $lista['prefila_op']; ?>
                                    </td>
                                    <td>
                                     ...
                                     <td>
                                          <?php echo $lista['prefila_cantidad_ini']; ?>
                                       
                                    </td>
                                     <td>
                                          <?php echo $lista['prefila_tipo']; ?>
                                       
                                    </td>
                                 <td>
                                          <?php echo $lista['fecha_creacion']; ?>
