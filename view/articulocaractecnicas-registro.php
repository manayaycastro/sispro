                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12"> 
                                            ...
                                            <div class="col-xs-3">
                                                <a class="btn btn-primary" id ="editar_caractart" >
                                                    <i class="ace-icon fa fa-plus align-top bigger-125"></i>
                                                    Nuevo
                                                </a>
                                                 <input type='hidden' id='tipsemi' value ='2'>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                                        <a class="blue"
                                                                           onclick=" false"  href="#" data-asignarmaq ="<?php echo $artsemiter ['artsemi_id']; ?>" id="asignarmaqtelares"
                                                                           >
                                                                            <i class="ace-icon fa fa-check-square-o bigger-130"></i>
                                                                        </a>

                                                                        <a class="blue"
                                                                           onclick=" false" href="#" data-estado ="<?php echo $artsemiter ['artsemi_id']; ?>" id="editar_caractart"
                                                                           >
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                                ...
                                                                                <li>
                                                                                    <a class="tooltip-error" id="bootbox-confirm"
                                                                                       href=""  data-rel="tooltip" title="Eliminar">
                                                                                        <span class="red">
