                                                       ...
                                                       <label for="id-date-range-picker-1">Rango de Fecha</label>
                                                        ...
                                                        <div class="row">
                                                          ...
                                                          <input class="form-control" type="text" name="rango" id="rango" />
                                                             ...
                                                             <div class="row-fluid">
                            <div id="cargarproducresumen"></div>
                        </div>
                                    </div><!-- /.widget-body -->
        ...
        <script src="assets/js/bootstrap-colorpicker.min.js"></script>
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargarproducresumen').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-produccresumendia.php", {rango:$( "#rango").val()}, function(data){
                            $("#cargarproducresumen").html(data);
