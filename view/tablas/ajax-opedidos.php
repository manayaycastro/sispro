...
<div class="table-header">
    Results for "Latest Registered Domains"
                     ...
                     <input id ="ini" type="hidden" value="<?php echo $ini; ?>">
                       ...
                       <input id="tipdoc" type="hidden" value="VENTAS" >
...
<!--                                                                    <td class="hidden-480">
                        ...
                        <!--<td><?php // echo $lista ['conpag']; ?></td>-->
                              ...
                              <td><?php echo $lista ['desart']; ?></td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right dropdown-125 dropdown-lighter dropdown-close dropdown-caret">
                                                ...
                                                <li>
                                                 ...
                                                 <li>
                                                        <a >
                                                                <i class="ace-icon fa fa-caret-right bigger-110 invisible">&nbsp;</i>
                                                                <?php echo $lista ['tabgendet_nombre']; ?> (Impresión)
                                                        </a>
                                                </li>
                                        </ul>
                                 </div>
                                ...
                                <td>
                                    ...
                                    <?php if ($lista ['prodped_id'] != null): ?> checked="checked" disabled="disabled"<?php else: ?> <?php endif; ?>
                                    id="aprobventas" data-aprobventas="<?php echo  $lista ['nroped']; ?>"

                                    />
                                    <span class="lbl"></span>
                                       <input id ="iddisenovig-<?php echo  $lista ['nroped']; ?>" type="hidden" value="<?php echo $lista ['prodidet_id']; ?>">
                                        <input id ="diseno-<?php echo  $lista ['nroped']; ?>" type="hidden" value="<?php echo $lista ['tabgendet_nombre']; ?>">
                                </td>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                 ...
                                 <a class="blue" 
                                    onclick=" false" href="#" data-notaped="<?php echo $lista ['nroped']; ?>" id="mostrarnotaped"
                                   >
...
<!--                        <div class="modal-header">
            ...
            <!-- Fin del modal acceso -->
              ...
              <!-- /.Inicio del modal NOTA DE PEDIDO -->
            <div id="modal-pdf-notaped" class="modal" tabindex="-1">
                <div class="modal-dialog" id="mdialTamanio">
                    <!--class="modal-dialog modal-lg"-->
                    <div class="modal-content">
<!--                        <div class="modal-header">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller">Vista pdf para la OP numero <span id="datosActualTXT2"></span></h4>
                                            </div>
