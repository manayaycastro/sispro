       ...
       $estado=$filter->process($_REQUEST['estado']); 
        $procesos=$filter->process($_REQUEST['procesos']); 
         $maquina=$filter->process($_REQUEST['maquina']); 
          $area_proc=$filter->process($_REQUEST['area_proc']); 
//    }    
...
$paradas = new parada();
	 ...
	 $listaparadas =$paradas->consultarParadas($ini,$fin,$area_proc,$estado,$maquina);
    ...
    Results for "Latest Registered Domains"
     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php if (count($listaparadas)): ?>
                <?php foreach ($listaparadas as $parada): ?>
                     <tr>
                                                                <td class="center">
                                                                    <label class="pos-rel">
                                                                        <input type="checkbox" class="ace" />
...
<!--                                                                        <a class="blue"
            ...
            <?php endif; ?>
                          ...
                          <!-- /.Inicio del modal regisparada  -->
            <div id="modal-regisparada" class="modal" tabindex="-1" >
                                    ...
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller"> Parada ID. <span id="datosActualParada"></span></h4>
                                            </div>
