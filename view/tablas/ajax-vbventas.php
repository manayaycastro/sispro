                        ...
                        <!--<td><?php // echo $lista ['conpag']; ?></td>-->
                              ...
                              <td><?php echo $lista ['desart']; ?></td>
                                ...
                                <div class="inline dropdown-hover">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right dropdown-125 dropdown-lighter dropdown-close dropdown-caret">
                                                ...
                                                <li>
                                                        <a >
                                                                <i class="ace-icon fa fa-caret-right bigger-110 invisible">&nbsp;</i>
                                                                <?php echo $lista ['prodped_fecaprob']; ?> (Aprobado por Ventas)
                                                        </a>
                                                </li>
                                        </ul>
                                 </div>
                                ...
                                <td>
                                    ...
                                    <?php if ($lista ['numaprobaciones'] == '2'): ?> checked="checked" disabled="disabled"<?php else: ?> <?php endif; ?>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="blue" 
                                        ...
                                        <?php if ($lista ['numaprobaciones'] == '2'): ?>  id='#' <?php else: ?>id="mostrarobs" <?php endif; ?>
                                    onclick=" false" href="#" data-obsped="<?php echo $lista ['nroped']; ?>"
                                   >
