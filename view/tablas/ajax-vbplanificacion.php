        ...
        <thead>
         ...
         <th>Cod. Art.</th>
                  <th class="hidden-480">Nomb. Producto</th>
                   <th>+ ver mas!</th>
                      <th class="hidden-480">MetrosXRollo</th>
                      <th class="hidden-480">Largo Corte</th>
                       <th class="hidden-480">Largo Parche</th>
                         <th>% Clase B</th>
                   <th>Gen.Kanban</th>
                <th>Acción</th>
...
<!--                                                                    <td class="hidden-480">
                        ...
                        <!--<td><?php // echo $lista ['conpag']; ?></td>-->
                              ...
                              <td><?php echo $lista ['desart']; ?></td>
                                ...
                                <div class="inline dropdown-hover">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right dropdown-125 dropdown-lighter dropdown-close dropdown-caret">
                                                ...
                                                <li>
                                                        <a >
                                                                <i class="ace-icon fa fa-caret-right bigger-110 invisible">&nbsp;</i>
                                                                <?php echo $lista ['prodped_fecaprob']; ?> (Aprobado por ASC)
                                                        </a>
                                                </li>
                                ...
                                <td>
                                    ...
                                    <input  style="width: 50px; height:32px" id ="idmetrosxrollo-<?php echo  $lista ['nroped']; ?>" type="text" 
                                           <?php if ($lista ['metrosrollo'] != null): ?> readonly="readonly" value="<?php echo ROUND ( $lista ['metrosrollo'],2); ?>"<?php else: ?>  value=""<?php endif; ?>  
                                 ...
                                 <td>
                                           <input style="width: 50px; height:32px" id ="idlargocorte-<?php echo  $lista ['nroped']; ?>" type="text"
                                  <?php if ($lista ['corteconversion'] != null): ?> readonly="readonly" value="<?php echo  ROUND ($lista ['corteconversion'],2); ?>"<?php else: ?>  value=""<?php endif; ?>  
                                 ...
                                 <td>
                                           <input style="width: 50px; height:32px" id ="idlargoparche-<?php echo  $lista ['nroped']; ?>" type="text"
                                  <?php if ($lista ['largoparche'] != null OR $lista ['largoparche'] == 0): ?> readonly="readonly" value="<?php echo  ROUND ($lista ['largoparche'],2); ?>"<?php else: ?>  value=""<?php endif; ?>  
                                 ...
                                 <td>
                                           <input  style="width: 50px; height:32px" id ="idclaseb-<?php echo  $lista ['nroped']; ?>" type="text" 
                                 <?php if ($lista ['prokan_id'] != null): ?>  readonly="readonly" value="<?php echo  $lista ['prokan_porcent_b']; ?>"<?php else: ?>  value="0"<?php endif; ?>  
                                ...
                                <td>
                                    ...
                                    <?php if ($lista ['prokan_id'] != null): ?> checked="checked" disabled="disabled"<?php else: ?> <?php endif; ?>
                                    id="prograkanban" data-prograkanban="<?php echo  $lista ['nroped']; ?>"

                                    />
                                    
                                    <span class="lbl"></span>
                                       <input id ="idcantped-<?php echo  $lista ['nroped']; ?>" type="hidden" value="<?php echo $lista ['cantped']; ?>">
                                         <input id ="codart-<?php echo  $lista ['nroped']; ?>" type="hidden" value="<?php echo $lista ['codart']; ?>">
                                          <input id ="artsemi-<?php echo  $lista ['nroped']; ?>" type="hidden" value="<?php echo $lista ['artsemi_id']; ?>">
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="orange" 
                                    onclick=" false" href="#" data-listakanban="<?php echo $lista ['nroped']; ?>" id="mostrarlistkanban"
                                   >
...
<!--                        <div class="modal-header">
            ...
            <!-- Fin del modal acceso -->
              ...
              <!-- /.Inicio del modal kanban -->
            <div id="modal-listakanban" style="overflow-y: scroll;" class="modal" tabindex="-1" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" id="mdialTamanio">
                    <!--class="modal-dialog modal-lg"-->
                    <div class="modal-content">
                      <div class="modal-header">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller"> OP numero <span id="datosActualTXTop"></span></h4>
                                            </div>

                                            <div class="widget-body" >
                                                <div  class="centro" id="centro">
                                                  
                                                    <div id = "ver_listakanban">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller">Lista de Telares <span id="datosActualTXTtelares"></span></h4>
                                            </div>
...
<!--        <button type="button" class="btn btn-sm" data-dismiss="modal">
          ...
          <button type="button" class="btn btn-sm btn-primary"  id="ActualizarListaTelares">
            <i class="ace-icon fa fa-check"></i>
            Salir (update)
        </button>
    </div>
