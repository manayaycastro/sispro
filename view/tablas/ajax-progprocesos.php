     ...
     <table id="dynamic-table" class="table table-striped table-bordered table-hover">
        <thead>
            <tr>
                ...
                <!--<th>Vendedor</th>-->
                <th class="hidden-480">Metros por Programado (Máquina)</th>
...
<!--                                                        <th>
         ...
         <th>Cod. Art.</th>
                  <th class="hidden-480">Fecha Atención(Sistema)</th>
            ...
            <?php if (count($listaprocesos)): ?>
                <?php foreach ($listaprocesos as $lista): ?>
                    <tr>
                        ...
                        <td><?php echo round ($lista ['metros_procanterior'],2) ." <------>( ".$lista ['maq_nombre']." )"; ?></td>



                               <td><?php echo $lista ['codart']; ?></td>

                              <td><?php echo $lista ['movdismaq_fecfin']; ?></td>
                                ...
                                <td> 
                                    ...
                                    <input type="date" readonly="readonly" name="fec-<?php echo  $lista ['prokandet_id']; ?>" 
                                            id="fec-<?php echo  $lista ['prokandet_id']; ?>"value="<?php echo  $lista ['progpro_fecprogramacion'] ?>">
                                ...
                                <td>
                                    ...
                                    <?php if ($lista ['progpro_id'] != null): ?> checked="checked" disabled="disabled"<?php else: ?> <?php endif; ?>
                                    id="progprocesos" data-progprocesos="<?php echo  $lista ['prokandet_id']; ?>"
                                    ...
                                    <span class="lbl"></span>
                                       <input id ="codart-<?php  echo  $lista ['prokandet_id']; ?>" type="hidden" value="<?php  echo $lista ['codart']; ?>">
                                        <input id ="artsemi_id-<?php  echo  $lista ['prokandet_id']; ?>" type="hidden" value="<?php  echo $lista ['artsemi_id']; ?>">
                                          <input id ="items-<?php  echo  $lista ['prokandet_id']; ?>" type="hidden" value="<?php  echo $lista ['prokandet_items']; ?>">
                                            <input id ="opedido-<?php  echo  $lista ['prokandet_id']; ?>" type="hidden" value="<?php  echo $lista ['prokandet_nroped']; ?>">
                                </td>
...
<!--                                 <a class="blue"
                                ...
                                <a class="orange" 
                                   ...
                                   >
                                     <!--movdismaq_maqid glyphicon-list-alt  href="index.php?page=opedido&accion=mostrarnotaped&id=<?php // echo $lista["nroped"]; ?>"-->
