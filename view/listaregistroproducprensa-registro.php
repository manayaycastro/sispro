                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Avance de Producción</li>
                        </ul><!-- /.breadcrumb -->
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Generar Registros</h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-6">
                                                            ...
                                                            <div class="row">
                                                             ...
                                                             <div class="row-fluid">
                            <div id="cargaravanceproduccion"></div>
                        </div>
        ...
        <script type="text/javascript">  
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargaravanceproduccion').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-gererarregistros.php", {rango:$( "#rango").val(),procesos:$( "#procesos").val(),estado:$( "#estado").val()}, function(data){
                            $("#cargaravanceproduccion").html(data);
