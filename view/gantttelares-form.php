                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Gantt Telares</h4>
        ...
        <script src="assets/js/bootstrap-colorpicker.min.js"></script>
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargargantt').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-mostrargantt.php", {rango:$( "#rango").val()}, function(data){
                            $("#cargargantt").html(data);
            ...
            <script type="text/javascript">
				...
				//var fecha_actual = fecha.getDate() + "/" + (fecha.getMonth() +1) + "/" + fecha.getFullYear();
				 ...
				 fecha.setDate(fecha.getDate() + neg);
				 fecha2.setDate(fecha2.getDate() + dias);
				 
					var fecha_1 = fecha.getDate() + "/" + (fecha.getMonth() +1) + "/" + fecha.getFullYear();
				//var fecfin =   fecha.setDate(fecha.getDate() + dias);
					var fecha_2 = fecha2.getDate() + "/" + (fecha2.getMonth() +1) + "/" + fecha2.getFullYear();
