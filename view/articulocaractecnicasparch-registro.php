...
<html lang="en">
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">Aseguramiento Calidad</a>
                            </li>
                            <li class="active">Parches</li>
                        </ul><!-- /.breadcrumb -->
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12"> 
                                            ...
                                            <div class="col-xs-3">
                                                <a class="btn btn-primary" id ="editar_caractart_parch" >
                                                    <i class="ace-icon fa fa-plus align-top bigger-125"></i>
                                                    Nuevo
                                                </a>
                                                <input type='hidden' id='tipsemi' value ='8'>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                                        ...
                                                                        <a class="blue"
                                                                           onclick=" false" href="#" data-estado ="<?php echo $artsemiter ['artsemi_id']; ?>" id="editar_caractart_parch"
                                                                           >
                                                                            <input type='hidden' id='descr-<?php echo $artsemiter ['artsemi_id']; ?>' value ='<?php echo $artsemiter ['artsemi_descripcion']; ?>'>
  ...
  <!-- /.Inicio del modal ORDEN DE PEDIDO -->
            <div id="modal-caractart" class="modal" tabindex="-1">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller">Carácteristicas Técnicas por producto (<span id="datosActualTXT"></span>)</h4>
                                            </div>
