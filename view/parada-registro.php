...
<html lang="en">
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12"> 
                                            ...
                                            <div class="col-xs-3">
                                                <a class="btn btn-primary" id ="editar_form_parada" >
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="hidden-480">Estado</th>
                                                           ...
                                                           <th class="hidden-480">Tipo de Parada</th>
                                                    ...
                                                    <?php if (count($paradas)): ?>
                                                        <?php foreach ($paradas as $parada): ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $parada ['par_id']; ?></td>
                                                                <td><?php echo $parada ['par_nombre']; ?></td>
                                                                
                                                              
                                                                <?php if ($parada ['par_estado'] == 0): ?>
                                                                    <td class="hidden-480">
            ...
            <div id="modal-form-parada" class="modal" tabindex="-1">
