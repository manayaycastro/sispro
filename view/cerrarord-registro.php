                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Lista de  Ordenes de Pedidos según fecha de vencimiento</h4>
                                                                      ...
                                                                      <select name="estado" id="estado" class="chosen-select form-control"     >
                                                                       ...
                                                                       <?php if (count($lista)): ?>
                                                                            <?php foreach ($lista as $list): ?>
                                                                                ...
                                                                                <option value="<?php echo round ( $list ['tabgendet_valor'],0) ;?>" >
...
//maquina
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargarops').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-cerrarops.php", {rango:$( "#rango").val(),estado:$( "#estado").val()}, function(data){
                            $("#cargarops").html(data);
