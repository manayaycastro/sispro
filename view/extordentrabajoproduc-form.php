                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                      <h4 class="widget-title lighter">Regisgtro de Orden de Trabajo Número : <?php echo $_GET["id"]; ?></h4>
                                                ...
                                                <div class="widget-main">
                                                            ...
                                                            <select name="tipdoc_id" id="tipdoc_id" class="form-control" <?php if (!empty($_GET["id"])): ?>  <?php endif; ?>
                                                                ...
                                                                <?php if (count($tipdocumentos)): ?>
                                                                    <?php foreach ($tipdocumentos as $tipdoc): ?>
                                                                        ...
                                                                        <option value="<?php echo $tipdoc ['tipdoc_id'] ?>" <?php if (!empty($_GET["id"])):if ($tipdoc ['tipdoc_id'] == '2'): ?> selected 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input name="ot" id="ot"type="hidden" 
                                                          <?php if (!empty($_GET["id"])) : ?>  value="<?php echo $_GET["id"]; ?>" <?php else: ?>  value="0" <?php endif; ?>>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="date"  required="required" placeholder="Fecha de puesta en marcha" class="form-control"
                                                                   name="extot_fecdoc" id="extot_fecdoc"
                                                                       <?php if (!empty($_GET["id"])) : ?> value="<?php echo date("Y-m-d"); ?>"  <?php endif; ?> readonly   />
...
<!--                                        <button class="btn btn-sm btn-primary" id="btn_buscar_maquinas" type="submit"<?php // echo $permiso; ?>>
            ...
            <script src="view/js/extcargarotproduccion.js"></script>

  <!--<script src="view/js/adicionales.js"></script>-->

            <script   src="view/js/capturatext.js"></script>
  <script type="text/javascript">
...
<!-- <script src="view/js/jquery-barcode.js"></script>
 <script src="view/js/jquery-barcode.min.js"></script>-->
