...
<form  class="form-horizontal" role="form" 
       action="index.php?page=clasiftipmaq&accion=insertar<?php if(!empty($_POST["id"])) :?>&id=<?php echo $_POST["id"]; endif; ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="Nombre de la clasificación" class="form-control" 
                                           name="clatipmaq_titulo"
                                           <?php if(!empty($_POST["id"])) :?> value="<?php echo $clasiftipmaq->getClatipmaq_titulo(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input name="optionsRadios" type="radio"  <?php echo $permiso; ?>  value="1"  class="ace"  <?php if(!empty($_POST["id"])) : if($clasiftipmaq->getClatipmaq_estado() == 1):?> checked <?php endif; endif; ?>/>
