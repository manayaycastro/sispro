                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <!--onchange="ShowSelected();" articulos $descr--> 
                                         <input type="hidden" name="tipsemi" id="tipsemi" value= "<?php echo  $tipsemi; ?>" >
                                        
										 <input type="text"  style="width: 200px; height:32px" name="nombreart" id="nombreart" <?php if (!empty($idsemiterminado)) : ?> value="<?php echo $descr; ?>" <?php else: ?>value=""<?php endif; ?>>

                                        <input type="hidden" name="articulos" id="articulos" <?php if (!empty($idsemiterminado)) : ?> value="<?php echo $idsemiterminado; ?>" <?php else: ?>value=""<?php endif; ?> >
