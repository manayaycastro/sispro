...
<form  class="form-horizontal" role="form" 
       action="index.php?page=ocupacion&accion=insertar<?php if (!empty($_POST["id"])) : ?>&id=<?php echo $_POST["id"];
endif; ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="Nombre del Perfil" class="form-control" 
                                           name="ocupacion"
<?php if (!empty($_POST["id"])) : ?> value="<?php echo $ocupacion_id->getGoc_descripcion(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input name="optionsRadios" type="radio"  <?php echo $permiso; ?>  value="0"  class="ace"  <?php if(!empty($_POST["id"])) : if($ocupacion_id->getGoc_estado() == 0):?> checked <?php endif; endif; ?>/>
