                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            ...
                            $.post("view/tablas/ajax-avanceproduccrollosconver.php", {rango:$( "#rango").val(),procesos:$( "#procesos").val(),estado:$( "#estado").val(),maquina:$( "#maquina").val(),area:$( "#area").val()}, function(data){
