...
function cargarregistros() {
        ...
        var opc  =  document.getElementById("proroll_id").value;
                ...
                if(opc != -1  ){
                      $('#listaavanceproduccion').html('<center><img src="view/img/loading.gif"/></center>');   
                         cargarFormulario("listaavanceproduccion", "index.php?page=kanban&accion=cargarlista&cod="+opc);   
