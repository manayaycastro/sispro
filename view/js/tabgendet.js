...
function cargarregistros() {
        ...
        var opc  =  document.getElementById("tabgen_id").value;

                if(opc != -1  ){
                      $('#listatabgen').html('<center><img src="view/img/loading.gif"/></center>');   
                         cargarFormulario("listatabgen", "index.php?page=tabgeneral&accion=cargarlista&cod="+opc);   
