        ...
        var opc  =  document.getElementById("proroll_id").value;
         var procesos =  document.getElementById("procesos").value;
                if(opc != -1  ){
					...
					if(procesos == '173'){
						              $('#listaavanceproduccionminiroll').html('<center><img src="view/img/loading.gif"/></center>');   
                         cargarFormulario("listaavanceproduccionminiroll", "index.php?page=kanban&accion=cargarlistaminiroll&cod="+opc+"&procesos="+procesos);   
					 ...
					 $('#listaavanceproduccionsacos').html('<center><img src="view/img/loading.gif"/></center>');   
                      ...
                      $('#listaavanceproduccionsacos').html('<center><img src="view/img/loading.gif"/></center>');   
                         cargarFormulario("listaavanceproduccionsacos", "index.php?page=kanban&accion=cargarlistasacos&cod="+opc+"&procesos="+procesos);   
					}
