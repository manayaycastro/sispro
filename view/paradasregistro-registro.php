                                    ...
                                    <div class="widget-main">
                                        <div id="fuelux-wizard-container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3">
                                                    <a class="btn btn-primary" id="editar_parada" data-estado = "0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input type ="hidden" id="area_proc" name ="area_proc" value="<?php echo $area_proc ; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                $(document).ready(function () {
                    $("#rango").change(function () {
                        $("#rango").each(function () {
                            ...
                            $.post("view/tablas/ajax-paradaslista.php", {rango: $("#rango").val(), procesos: $("#procesos").val(), estado: $("#estado").val(), maquina: $("#maquina").val(), area_proc: $("#area_proc").val()}, function (data) {
