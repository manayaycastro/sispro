                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Resumen Producción</li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row-fluid">
                            ...
                            <?php if (  $tipo == 'ProduccionDetalleXCintas'):?>
                                <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Resumen de producción</h4>


                                </div>
                                
                                
                                <form  class="form-horizontal" method="post" action="index.php?page=telares&accion=reportprodprocimp" target="_blank">
                             ...
                             <?php elseif ( $tipo == 'ProduccionDetalleXDescripcion'):?>
                                ...
                                <form  class="form-horizontal" method="post" action="index.php?page=telares&accion=reportprodprocimp2" target="_blank">
