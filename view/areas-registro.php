    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12"> 
                                            <div class="col-xs-9">
                                                <h4 class="header smaller lighter blue">Cantidad de registros <span class="badge"><?php echo count($areas); ?></span></h4>
                                            </div>
                                            <div class="col-xs-3">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $area ['are_id']; ?></td>
                                                                 <td><?php echo $area ['are_titulo']; ?></td>
                                                                  <td><?php echo $area ['are_referencia']; ?></td>
                                                                 
                                                                 <td><?php echo $area ['descripcion']; ?></td>
                                                                 
                                                                  <td><?php echo $area ['codarea']; ?></td>
            ...
            <!-- /.Inicio del modal area -->
                <div id="modal-form-area" class="modal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="blue bigger">Título del Area: </h4>
                        </div>


                        <div id = "ver_form_area_detalle">
