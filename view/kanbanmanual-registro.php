...
<div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12"> 
                                            <div class="col-xs-9">
                                                <h4 class="header smaller lighter blue">Cantidad de registros <span class="badge"><?php echo count($kanban_manual); ?></span></h4>
                                            </div>
                                            <div class="col-xs-3">
                                                <a class="btn btn-primary" data-toggle="modal" data-target="#modal-kannmanual">
...
<div class="table-header">
  ...
  <th class="hidden-480">Ítems</th>
        ...
        <tbody>
            ...
            <?php if (count($kanban_manual)): ?>
                <?php foreach ($kanban_manual as $lista): ?>
                    <tr>
                        <td class="center">
                            <label class="pos-rel">
                                <input type="checkbox" class="ace" />
      ...
      <!-- /.Inicio del modal insertar kanban manual -->
               ...
               <div id="modal-kannmanual" class="modal" tabindex="-1" data-backdrop="static" data-keyboard="false">
...
<div class="modal-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="widget-box widget-color-blue2">
                                            <div class="widget-header">
                                                <h4 class="widget-title lighter smaller"> Ingreso de nuevo kanban.</h4>
                                            </div>
 ...
 <form  class="form-horizontal" role="form"  action="index.php?page=kanban&accion=insertarkanbmanual" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select name="opedido" class="chosen-select form-control" id="opedido" data-placeholder="Choose a State...">
...
<?php endif; ?>
                          ...
                          <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"  required="required" placeholder="Cantidad de kanban" class="form-control" 
                                           name="cantkanban" id="cantkanban"
value=""  />
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"  required="required" placeholder="Metros lienales por kanban" class="form-control" 
...
//        });
        ...
        $(document).on('click', '#dynamic-table .dropdown-toggle', function (e) {
            ...
            e.preventDefault();
                                    ...
                                    $('#modal-kannmanual').on('shown.bs.modal', function () {
                                        if (!ace.vars['touch']) {
