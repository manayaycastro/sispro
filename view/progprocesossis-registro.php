                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Lista de kanban para el proceso de <?php  echo $proceso?></h4>
                                                       ...
                                                       <label for="id-date-range-picker-1">Rango de Fecha</label>
                                                        ...
                                                        <div class="col-xs-6">
                                                            ...
                                                            <div class="row">
                                                             ...
                                                             <div class="row-fluid">
                            <div id="cargarprocesoactualsistema"></div>
                        </div>
                                    </div><!-- /.widget-body -->
        ...
        <script src="assets/js/bootstrap-colorpicker.min.js"></script>
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargarprocesoactualsistema').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-progprocesossis.php", {rango:$( "#rango").val(),proceso:$( "#proceso").val(),area:$( "#area").val(),estado:$( "#estado").val()}, function(data){
                            $("#cargarprocesoactualsistema").html(data);
