                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Lista de V.B. de Ventas</li>
                        </ul><!-- /.breadcrumb -->
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-blue widget-header-flat">
                                    <h4 class="widget-title lighter">Lista de Ordenes de Pedido - V.B. de Ventas</h4>
        ...
        <script src="assets/js/bootstrap-colorpicker.min.js"></script>
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargarvb').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-vbventas.php", {rango:$( "#rango").val()}, function(data){
                            $("#cargarvb").html(data);
