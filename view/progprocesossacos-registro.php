                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Programacion Procesos</li>
                        </ul><!-- /.breadcrumb -->
        ...
        <script type="text/javascript">  
                ...
                $(document).ready(function(){
                   $("#rango").change(function () {
                           $("#rango").each(function () {
                            $('#cargarproceso').html('<center><img src="view/img/loadingV02.gif"/></center>');   
                            $.post("view/tablas/ajax-progprocesossacos.php", {rango:$( "#rango").val(),procesos:$( "#procesos").val(),estado:$( "#estado").val()}, function(data){
                            $("#cargarproceso").html(data);
