...
$pdf->Cell(20,10,date("Y-m-d", $i),1,0,'C',1);
...
$pdf->Cell(18,10,"Clase A",1,0,'C',1);
$pdf->Cell(18,10,"TEL.",1,0,'C',1);
$pdf->Cell(18,10,"LAM.",1,0,'C',1);
$pdf->Cell(18,10,"IMP.",1,0,'C',1);
$pdf->Cell(18,10,"CONV.",1,0,'C',1);


$pdf->Cell(18,10,"Operario",1,0,'C',1);
$pdf->Cell(97,10,"Maquina",1,0,'C',1);
$pdf->Cell(71,10,utf8_decode("Observación"),1,0,'C',1);
$pdf->SetFillColor(201, 201, 201);
$pdf->ln(10);
	...
	if($lista_resumen){
		foreach ($lista_resumen as $lista){
			...
			if($lista['fechaproduccion']==date("Y-m-d", $i) and $lista['Turno']== 'Mañana'){
				...
				$pdf->Cell(18,10,$lista['prosacodet_id'],1,0,'C'); //orden de pedido
				...
				$pdf->Cell(18,10,round($lista['prosacodet_sacoa']),1,0,'C'); //orden de pedido
				$pdf->Cell(18,10,round($lista['prosacodet_sacotel']),1,0,'C'); //orden de pedido
                                $pdf->Cell(18,10,round($lista['prosacodet_sacolam']),1,0,'C'); //orden de pedido
				$pdf->Cell(18,10,round($lista['prosacodet_sacoimp']),1,0,'C'); //orden de pedido
                                $pdf->Cell(18,10,round($lista['prosacodet_sacoconv']),1,0,'C'); //orden de pedido
			
				$pdf->Cell(18,10,$lista['prosacodet_operario'],1,0,'C'); //orden de pedido
				$pdf->Cell(97,10,$lista['maq_nombre'],1,0,'C'); //orden de pedido
				$pdf->Cell(71,10,utf8_decode ($lista['prosacodet_obs']),1,0,'L'); //orden de pedido
				$pdf->ln();
			}
