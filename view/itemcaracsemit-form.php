...
<form  class="form-horizontal" role="form" 
       action="index.php?page=itemcaracsemit&accion=insertar<?php if (!empty($_POST["id"])) : ?>&id=<?php echo $_POST["id"];
endif;
?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="Nombre" class="form-control"
                                           name="itemcaracsemi_descripcion"
                                           <?php if (!empty($_POST["id"])) : ?> value="<?php echo $itemcaracsemit->getItemcaracsemi_descripcion(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                                           />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="Posición" class="form-control" 
                                           name="itemcaracsemi_pocision"
<?php if (!empty($_POST["id"])) : ?> value="<?php echo $itemcaracsemit->getItemcaracsemi_pocision(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                                           />
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="tipsem_id" class="chosen-select form-control" <?php echo $permiso; ?> id="form-field-select-3" data-placeholder="Choose a State...">
                                        <?php if (count($semiterminados)): ?>
                                                ...
                                                <option value="<?php echo $semit ['tipsem_id'] ?>" <?php if (!empty($_POST["id"])):if ($semit ['tipsem_id'] == $itemcaracsemit->getTipsem_id()): ?> selected <?php endif;
                                                                                                                             endif;
                                                        ?>>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="clasem_id" class="chosen-select form-control" <?php echo $permiso; ?> id="form-field-select-3" data-placeholder="Choose a State...">
                                        <?php if (count($clasifsemiterminado)): ?>
                                                ...
                                                <option value="<?php echo $clasifsemit ['clasem_id'] ?>" <?php if (!empty($_POST["id"])):if ($clasifsemit ['clasem_id'] == $itemcaracsemit->getClasem_id()): ?> selected <?php endif;
                                                                                                                             endif;
                                                        ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="itemcaracsemi_tipodato" class="chosen-select form-control" <?php echo $permiso; ?> id="form-field-select-3" data-placeholder="Choose a State...">
                                       <option value="_caja" <?php if (!empty($_POST["id"])):if ("_caja" == $itemcaracsemit->getItemcaracsemi_tipodato()): ?> selected <?php endif; endif; ?>>
                                              Caja de Texto
                                                </option>
                                       <option value="_combo" <?php if (!empty($_POST["id"])):if ("_combo" == $itemcaracsemit->getItemcaracsemi_tipodato()): ?> selected <?php endif; endif; ?>>
                                              Combo - Select
                                                </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="tabla" class="form-control"
                                           name="itemcaracsemi_tabla"
                                           <?php if (!empty($_POST["id"])) : ?> value="<?php echo $itemcaracsemit->getItemcaracsemi_tabla(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                                           />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder=" id tabla" class="form-control"
                                           name="itemcaracsemi_tabla_id"
                                           <?php if (!empty($_POST["id"])) : ?> value="<?php echo $itemcaracsemit->getItemcaracsemi_tabla_id(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                                           />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" required="required" placeholder="nombre tabla" class="form-control"
                                           name="itemcaracsemi_tabla_descripcion"
                                           <?php if (!empty($_POST["id"])) : ?> value="<?php echo $itemcaracsemit->getItemcaracsemi_tabla_descripcion(); ?>"<?php endif; ?> <?php echo $permiso; ?>
                                           />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input name="optionsRadios" type="radio"  <?php echo $permiso; ?>  value="1"  class="ace"  <?php if (!empty($_POST["id"])) : if ($itemcaracsemit->getItemcaracsemi_estado() == 1): ?> checked <?php endif;
endif; ?>/>
